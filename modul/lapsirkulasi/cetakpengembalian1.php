...
<br>
 ...
 <thead> <tr><th width='50px'>No</th><th>Buku</th><th>Peminjam</th><th>Status </th><th>Pinjam</th><th>Tempo</th><th>Kembali</th><th>Petugas</th><th>Denda perhari</th><th>Telat</th><th>Pembayaran</th></tr>
		</thead>
 <tbody>";
        $no = 1;
...
';
        ...
        $hitung = mysqli_query(KONEKSI, "select 
				sirkulasi.notransaksi,		sirkulasi.tglpinjam,
				denda.notransaksi,			denda.telat, denda.denda as bayardenda,
                SUM(denda.denda) as jml
			from sirkulasi
			left join denda			on denda.notransaksi		= sirkulasi.notransaksi
		 WHERE sirkulasi.tglpinjam BETWEEN '$tglawal' AND '$tglakhir'");
        while ($h = mysqli_fetch_array($hitung)) {

            echo '
      <tr> <td colspan=10> <p align=right><strong>Jumlah</strong></p></td><td> ';
            $uang = $h['jml'];
